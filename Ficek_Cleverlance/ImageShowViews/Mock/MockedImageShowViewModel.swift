...
final class MockedImageShowViewModel: ImageShowViewModelType {
    ...
    init(imageString: String = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNk+A8AAQUBAScY42YAAAAASUVORK5CYII=", imageBase64: Image = Image(systemName: "sun.fill")) {
